...
class FormCreate
{
    ...
    public function attributes($attributes, $isMiltiple,
                               $valueAttribute = true)
    {
        $tmp = array();
    ...
    {
        // Если для аргумента $name в массиве отсутсвует
        ...
        // находиться значение аргумента $value в массиве
